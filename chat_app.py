...
st.markdown(
    ...
    <style>  
        ...
        .main .block-container { padding: 0 1rem; max-width: 100%; background-color: #304666; border-radius: 10px; padding: 2rem; }  
        ...
        .stTextInput input { background-color: #304666 !important; color: white; }  
        .stButton button { background-color: #304666 !important; color: white; }  
        .stBottomBlockContainer { background-color: #304666 !important; }  
    </style>  
    """,
